...
/**
 * This is a class to run experiments using SSD 1NN
 *
 * @author Chang Wei
 */
public class BaselineSSD1NN {
    public static void main(String[] args) throws Exception {
        ...
        outputPath += "SSD1NN/";
        System.out.println(String.format("[BASELINE-SSD1NN] Output path:    %s", outputPath));
        System.out.println(String.format("[BASELINE-SSD1NN] Dataset path:   %s", datasetPath));
        System.out.println(String.format("[BASELINE-SSD1NN] Problem:        %s", problem));
        System.out.println(String.format("[BASELINE-SSD1NN] ParamID:        %s", paramId));
        System.out.println(String.format("[BASELINE-SSD1NN] Norm:           %s", norm));
        System.out.println(String.format("[BASELINE-SSD1NN] Process:        %d", process));
        System.out.println(String.format("[BASELINE-SSD1NN] Method:         %d", method));
        ...
        System.out.println("[BASELINE-SSD1NN] Start Classifying");
        final double accuracy = classifier.accuracy(testData);
        System.out.println(String.format("[BASELINE-SSD1NN] Accuracy: %.4f", accuracy));
        System.out.println(String.format("[BASELINE-SSD1NN] Loss: %.4f", 1 - accuracy));

        OutFile outFile = new OutFile(outputPath, problem + "_" + norm + "_" + method + "_EuclideanShift1NN.csv");
