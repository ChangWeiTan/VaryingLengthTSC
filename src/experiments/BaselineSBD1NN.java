...
/**
 * This is a class to run experiments using SBD 1NN
 *
 * @author Chang Wei
 */
public class BaselineSBD1NN {
    public static void main(String[] args) throws Exception {
        ...
        String problem = "Adiac";
        String datasetPath = "C:/Users/" + System.getProperty("user.name") + "/workspace/Dataset/UCRArchive_2018_Non_Uniform_Sampling2/";
        ...
        outputPath += "SBD1NN/";
        System.out.println(String.format("[BASELINE-SBD1NN] Output path:    %s", outputPath));
        System.out.println(String.format("[BASELINE-SBD1NN] Dataset path:   %s", datasetPath));
        System.out.println(String.format("[BASELINE-SBD1NN] Problem:        %s", problem));
        System.out.println(String.format("[BASELINE-SBD1NN] ParamID:        %s", paramId));
        System.out.println(String.format("[BASELINE-SBD1NN] Norm:           %s", norm));
        System.out.println(String.format("[BASELINE-SBD1NN] Process:        %d", process));
        System.out.println(String.format("[BASELINE-SBD1NN] Method:         %d", method));
        ...
        System.out.println("[BASELINE-SBD1NN] Start Classifying");
        final double accuracy = classifier.accuracy(testData);
        System.out.println(String.format("[BASELINE-SBD1NN] Accuracy: %.4f", accuracy));
        System.out.println(String.format("[BASELINE-SBD1NN] Loss: %.4f", 1 - accuracy));

        OutFile outFile = new OutFile(outputPath, problem + "_" + norm + "_" + method + "_SBD1NN.csv");
