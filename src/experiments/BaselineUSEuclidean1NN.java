...
import classifiers.USEuclidean1NN;
...
/**
 * This is a class to run experiments using Uniform Sampling 1NN
 *
 * @author Chang Wei
 */
public class BaselineUSEuclidean1NN {
    public static void main(String[] args) throws Exception {
        ...
        outputPath += "USEuclidean1NN/";
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Output path:    %s", outputPath));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Dataset path:   %s", datasetPath));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Problem:        %s", problem));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] ParamID:        %s", paramId));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Norm:           %s", norm));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Process:        %d", process));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Method:         %d", method));
        ...
        System.out.println("[BASELINE-USEuclidean1NN] Start Classifying");
        final double accuracy = classifier.accuracy(testData);
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Accuracy: %.4f", accuracy));
        System.out.println(String.format("[BASELINE-USEuclidean1NN] Loss: %.4f", 1 - accuracy));

        OutFile outFile = new OutFile(outputPath, problem + "_" + norm + "_" + method + "_USEuclidean1NN.csv");
