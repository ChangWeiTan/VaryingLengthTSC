...
import classifiers.Euclidean1NN;
...
/**
 * This is a class to run experiments using Euclidean 1NN
 *
 * @author Chang Wei
 */
public class BaselineEuclidean1NN {
    public static void main(String[] args) throws Exception {
        ...
        outputPath += "Euclidean1NN/";
        System.out.println(String.format("[BASELINE-Euclidean1NN] Output path:    %s", outputPath));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Dataset path:   %s", datasetPath));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Problem:        %s", problem));
        System.out.println(String.format("[BASELINE-Euclidean1NN] ParamID:        %s", paramId));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Norm:           %s", norm));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Process:        %d", process));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Method:         %d", method));
        ...
        System.out.println("[BASELINE-Euclidean1NN] Start Classifying");
        final double accuracy = classifier.accuracy(testData);
        System.out.println(String.format("[BASELINE-Euclidean1NN] Accuracy: %.4f", accuracy));
        System.out.println(String.format("[BASELINE-Euclidean1NN] Loss: %.4f", 1 - accuracy));

        OutFile outFile = new OutFile(outputPath, problem + "_" + norm + "_" + method + "_Euclidean1NN.csv");
