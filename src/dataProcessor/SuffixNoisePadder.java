...
/**
 * This is a class to pad the suffix with low amplitude random noise
 *
 * @author Chang Wei
 */
public class SuffixNoisePadder extends DataProcessor {
    public static void main(String[] args) {
        ...
        final String problem = "ShakeGestureWiimoteZ";
        final int method = 1;

        System.out.println(String.format("[SUFFIX-NOISE] Loading %s problem", problem));
        ...
        System.out.println(String.format("[SUFFIX-NOISE] Loading Z-Norm %s problem", problem));
    ...
    public SuffixNoisePadder(final Random random) {
        this.random = random;
    }

    public SuffixNoisePadder(final long seed) {
